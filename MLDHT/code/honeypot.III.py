            ...
            if id not in self.nodePool:
                ...
                if id != self.id:
                    ...
                    for i in range(len(self.honey)):
                        # Liang: Test purpose
                        if n["host"] == "50.18.3.51":
                            print '-'*100, node["host"], node["port"]
...
if __name__=="__main__":
    ...
    id  = 120479063300798688358042732910209518322271467239L
    honey = [ stringify(id+i) for i in range(1, 11) ]
    #honey = [ stringify(120000063300798688358042732910209518322271467239L) ]
    #honey = [ stringify(id+i*15) for i in range(1, 11) ]
    id  = stringify(id)
    honeypot = Honeypot(id)
